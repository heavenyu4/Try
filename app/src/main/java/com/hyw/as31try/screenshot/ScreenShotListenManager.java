package com.hyw.as31try.screenshot;

/**
 * Created by http://blog.csdn.net/xietansheng/article/details/52692163.
 */
...
public class ScreenShotListenManager {
    ...
    private ScreenShotListenManager(Context context, boolean isNotch) {
        if (context == null) {
    ...
    public static ScreenShotListenManager newInstance(Context context, boolean isNotch) {
        assertInMainThread();
        return new ScreenShotListenManager(context, isNotch);
    }
