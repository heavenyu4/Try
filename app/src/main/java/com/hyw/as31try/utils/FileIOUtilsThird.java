 ...
 * </pre>
 */
public final class FileIOUtilsThird {

    private FileIOUtilsThird() {
    ...
    public static List<String> readFile2List(final File file,
        ...
        try {
            ...
            CloseUtilsThird.closeIO(reader);
        }
    }
    ...
    public static byte[] readFile2BytesByStream(final File file) {
        ...
        try {
            ...
            CloseUtilsThird.closeIO(fis, os);
        }
    }
